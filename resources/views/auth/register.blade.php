    ...
    <header class="sp-header">
      <div class="sp-logo-wrap pull-left">
        <a href="index.html">
          ...
          <span class="brand-text">Deawoo Express</span>
        </a>
      </div>
            ...
            <div class="auth-form  ml-auto mr-auto no-float">
              <div class="row">
                <div class="col-sm-12 col-xs-12">
                  <div class="mb-30">
                    <h3 class="text-center txt-dark mb-10">Sign up to Daewoo Express</h3>
                  ...
                  <div class="form-wrap">
                    <form method="POST" action="{{ route('register') }}">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" id="exampleInputName_1"
                      ...
                      <div class="form-group">
                        <input type="password" class="form-control" required="" id="exampleInputpwd_3"
                          placeholder="Enter pwd" name="password_confirmation">
                      </div>
                      <!--   <div class="form-group">
